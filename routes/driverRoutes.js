...
router.get(
  "/dashboard",
  driverAuthMiddleware.isDriverLoggedIn,
  driverController.getDriverDashboard
);
router.get(
  "/pending-requests",
  driverAuthMiddleware.isDriverLoggedIn,
  driverController.getPendingRequests
);
router.get(
  "/resolve-request",
  driverAuthMiddleware.isDriverLoggedIn,
  driverController.resolveRequest
);
router.get(
  "/reject-request",
  driverAuthMiddleware.isDriverLoggedIn,
  driverController.rejectRequest
);
router.get(
  "/history",
  driverAuthMiddleware.isDriverLoggedIn,
  driverController.getRequestHistory
);
